...
function App() {
  return (
    ...
    <SectionCard />
     <Hero h6="Experience AccuPay" h3="We've got everything you need?" para="We save you from all that boring paperwork! From global hiring, to instant payments, and taxes, we've got your back." img_src="/images/contact_illus.png" styl="btn-1"/> 
    <Footer/>
    </>
  );
}
