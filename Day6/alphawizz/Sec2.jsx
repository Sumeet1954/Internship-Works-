     ...
     <section className="sec-2">
          ...
          <div className="item2">
            ...
            <section className="sub-sec-2">
              ...
              <div className="div-1">
               <span> <img src="/images/file.png" id="icn-prt-1"/></span>
               <span id="cntr"> <span>Tax Preparation</span></span>
              </div>
               <div className="div-2">
                <img src="/images/shuttle.png" id="icn-prt-1" />
                <span id="cntr">Scale Rapidly</span>
               </div>
                <div className="div-3">
                  <img src="/images/hand-with-heart.png" id="icn-prt-1"/>
                <span id="cntr">Payroll Processing</span>
                </div>
                 <div className="div-4">
                  <img src="/images/lamp.png" id="icn-prt-1"/>
                <span id="cntr">Cost Effective</span>
                 </div>
              </div>
            </section>
          </div>
